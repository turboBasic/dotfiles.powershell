...
task Clean {
	Get-Item z, Tests\z, Tests\z.*, $toolsDir, README.html, Release-Notes.html, dotfiles.powershell.*.nupkg -errorAction SilentlyContinue | 
...
task Help {
    ...
    . .\dotfiles.powershell\profile\Public\Invoke-DefaultProfile.ps1
